...
png("figures/FigS11.png", width = 4000, height = 4000, units = "px", res = 600)
FigS11A <- ggplot(all[data == "behaviour"]) +
...
FigS11C <- ggplot(all[data == "behaviour"]) +
