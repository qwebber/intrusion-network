...
polys2013KL$gr_year <- rep("2013 (n = 75)", length(polys2013KL$id_polygons))
...
polys2015KL$gr_year <- rep("2015 (n = 53)", length(polys2015KL$id_polygons))
...
polys2018KL$gr_year <- rep("2018 (n = 76)", length(polys2018KL$id_polygons))
polys2019KL <- sf::st_transform(polys[[45]])
polys2019KL$gr_year <- rep("2019 (n = 81)*", length(polys2019KL$id_polygons))
...
polys1999SU$gr_year <- rep("1999 (n = 12)", length(polys1999SU$id_polygons))
